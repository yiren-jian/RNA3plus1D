...
class C4D(nn.Module):
    ...
    def __init__(self, num_classes, batch_norm=False):
        ...
        self.conv1a = Conv4d(3, 32, kernel_size=(3, 3, 3, 3), padding=(1, 1, 1, 1), stride=(2, 1, 1, 1), dilation=(1, 1, 1, 1), bias=True )
        self.bn1a = nn.BatchNorm1d(32)
        self.pool1 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))

        self.conv2a = Conv4d(32, 64, kernel_size=(3, 3, 3, 3), padding=(1, 1, 1, 1), stride=(2, 1, 1, 1), dilation=(1, 1, 1, 1), bias=True )
        self.bn2a = nn.BatchNorm1d(64)
        self.pool2 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))

        self.conv3a = Conv4d(64, 128, kernel_size=(3, 3, 3, 3), padding=(1, 1, 1, 1), stride=(2, 1, 1, 1), dilation=(1, 1, 1, 1), bias=True )
        self.bn3a = nn.BatchNorm1d(128)
        self.pool3 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))

        self.conv4a = Conv4d(128, 256, kernel_size=(3, 3, 3, 3), padding=(1, 1, 1, 1), stride=(2, 1, 1, 1), dilation=(1, 1, 1, 1), bias=True )
        self.bn4a = nn.BatchNorm1d(256)
        self.pool4 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))

        self.conv5a = Conv4d(256, 256, kernel_size=(3, 3, 3, 3), padding=(1, 1, 1, 1), stride=(2, 1, 1, 1), dilation=(1, 1, 1, 1), bias=True )
